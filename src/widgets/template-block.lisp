...
(export '(template-block-mixin template-block-source template-block-vars recreate-template-printer render-template))
...
(defmethod render-template ((obj template-block-mixin))
