...
(defwidget navigation (static-selector)
  ((pane-names :accessor navigation-pane-names
   ...
   (disabled-panes :accessor navigation-disabled-panes
		   ...
		   :documentation "Allows presenting panes to the user
                        as a visual queue, but disabling access to
                        them. If not null, this slot should be bound to
                        a list of pane uri-tokens to be disabled.")
...
(defgeneric render-navigation-menu (obj &rest args)
  ...
  (:method ((obj navigation) &rest args)
    ...
    (render-menu
     ...
     :disabled-panes (navigation-disabled-panes obj)
